...
export default function RangeSlider({ range, setRange, userCount }: RangeSliderProps) {
    ...
    return (
        <div className="flex justify-between items-center w-full gap-5 text-xs h-8 p-2 shadow-md shadow-gray-300 bg-gray-100">
            <h1 className="w-3/12 text-center">Users: {userCount}</h1>
